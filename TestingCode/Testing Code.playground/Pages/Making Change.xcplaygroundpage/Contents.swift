/*:
 ...
 Imagine that you're writing code for an automated checkout machine at a supermarket. You've created a function that decides how to dispense change when the shopper pays. Below is the documentation for the function. (You can also Option-click the function name below in your code to see the documentation.)
